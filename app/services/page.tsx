							...
							<div className="row mt-50">
									...
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Daily and Weekly Car Rentals</Link>
											...
											<div className="card-program">
												<div className="endtime">
													<div className="card-button"><Link className="btn btn-primary2" href="">View Details</Link></div>
												</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Long-Term Rentals</Link>
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Luxury Car Rentals</Link>
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">VIP Transfer Services</Link>
												<p className="text-md-medium neutral-500 mt-2">Flexible rental options available for both short-term and weekly needs, ideal for vacations or business trips.</p>
											</div>
											<div className="card-program">
												<div className="endtime">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Concierge Services</Link>
												<p className="text-md-medium neutral-500 mt-2">Flexible rental options available for both short-term and weekly needs, ideal for vacations or business trips.</p>
											</div>
											<div className="card-program">
												<div className="endtime">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Roadside Assistance</Link>
												<p className="text-md-medium neutral-500 mt-2">Flexible rental options available for both short-term and weekly needs, ideal for vacations or business trips.</p>
											</div>
											<div className="card-program">
												<div className="endtime">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										...
										<div className="card-info">
											<div className="card-title mb-3">
												<Link className="text-xl-bold neutral-1000" href="">Customizable Rental Packages</Link>
												<p className="text-md-medium neutral-500 mt-2">Flexible rental options available for both short-term and weekly needs, ideal for vacations or business trips.</p>
											</div>
											<div className="card-program">
												<div className="endtime">
