											...
											<div className="box-content-detail-blog">
												<div className="box-content-info-detail mt-0 pt-0">
													...
													<div className="d-flex flex-md-row flex-column align-items-center justify-content-center gap-3 mb-30">
														<div>
															<img src="/assets/imgs/blog/img-1.png" alt="Carento" />
														</div>
														<div>
															<img src="/assets/imgs/blog/img-2.png" alt="Carento" />
														</div>
													</div>
													<div className="content-detail-post">
													...
													<div className="row mb-30 d-none d-md-block">
														<div className="col-8 mx-auto">
															<div className="p-4 position-relative">
																<img className="position-absolute top-0 start-0 bottom-0 end-0 z-0 h-100" src="/assets/imgs/blog/banner-img.png" alt="Carento" />
																<img className="position-absolute top-0 end-0 z-1" src="/assets/imgs/blog/banner-car.png" alt="Carento" />
													...
													<div className="content-detail-post">
														...
														<div className="d-flex flex-md-row flex-column align-items-center justify-content-center gap-3 mb-30">
															<div>
																<img src="/assets/imgs/blog/img-3.png" alt="Carento" />
															</div>
															<div>
																<img src="/assets/imgs/blog/img-4.png" alt="Carento" />
															</div>
														</div>
														<h6>Conclusion</h6>
													...
													<div className="box-list-comment background-card mb-0">
														<div className="list-reviews">
															<div className="item-review">
																<div className="head-review">
																	<div className="author-review">
																		<img src="/assets/imgs/blog/avatar-1.png" alt="Carento" />
															...
															<div className="item-review">
																<div className="head-review">
																	<div className="author-review">
																		<img src="/assets/imgs/blog/avatar-2.png" alt="Carento" />
																		<div className="author-info">
															...
															<div className="item-review">
																<div className="head-review">
																	<div className="author-review">
																		<img src="/assets/imgs/blog/avatar-3.png" alt="Carento" />
																		<div className="author-info">
												...
												<div className="box-content-sidebar">
													<ul className="list-posts">
														<li>
															<div className="card-post">
																<div className="card-image">
																	<Link href=""><img src="/assets/imgs/blog/blog-list/trending.png" alt="Carento" /></Link>
																</div>
																<div className="card-info">
																	<Link className="text-md-bold neutral-1000" href="">How to Choose the Best Insurance for Your Rental Car</Link>
														...
														<li>
															<div className="card-post">
																<div className="card-image">
																	<Link href=""><img src="/assets/imgs/blog/blog-list/trending1.png" alt="Carento" /></Link>
																</div>
																<div className="card-info">
																	<Link className="text-md-bold neutral-1000" href="">The Advantages of Renting a Car for Business Travel</Link>
																	<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
																</div>
															</div>
														</li>
														<li>
															<div className="card-post">
																<div className="card-image">
																	<Link href=""><img src="/assets/imgs/blog/blog-list/trending2.png" alt="Carento" /></Link>
																</div>
																<div className="card-info">
																	<Link className="text-md-bold neutral-1000" href="">Why Renting a Car Is Ideal for Exploring National Parks</Link>
																	<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
																</div>
															</div>
														</li>
														<li>
															<div className="card-post">
																<div className="card-image">
																	<Link href=""><img src="/assets/imgs/blog/blog-list/trending3.png" alt="Carento" /></Link>
																</div>
																<div className="card-info">
																	<Link className="text-md-bold neutral-1000" href="">How to Extend Your Car Rental Without Hassle</Link>
																	<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
																</div>
															</div>
														</li>
														<li>
															<div className="card-post">
																<div className="card-image">
																	<Link href=""><img src="/assets/imgs/blog/blog-list/trending4.png" alt="Carento" /></Link>
																</div>
																<div className="card-info">
																	<Link className="text-md-bold neutral-1000" href="">The Ultimate Checklist for Returning Your Rental Car</Link>
																	<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
																</div>
															</div>
														</li>
