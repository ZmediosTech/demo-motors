							...
							<div className="col-lg-7">
								<div className="card-grid-video wow fadeIn">
									...
									<div className="card-info">
										...
										<p className="text-md-medium text-white">28 Feb 2025</p>
									</div>
								</div>
							</div>
								...
								<div className="list-videos-small">
									<div className="item-video-small wow fadeIn" data-wow-delay="0.1s">
										...
										<div className="item-info">
											<Link className="heading-6" href="">Best Midsize 3-row SUVs 2024</Link>
											<p className="text-md-medium neutral-500">28 Feb 2025</p>
										</div>
									</div>
									<div className="item-video-small wow fadeIn" data-wow-delay="0.2s">
										...
										<div className="item-info">
											<Link className="heading-6" href="">5 Best Luxury sport coupes
												2024</Link>
											<p className="text-md-medium neutral-500">28 Feb 2025</p>
										</div>
									</div>
									<div className="item-video-small wow fadeIn" data-wow-delay="0.3s">
										...
										<div className="item-info">
											<Link className="heading-6" href="">Best Small hatchbacks 2024 and
												2025</Link>
											<p className="text-md-medium neutral-500">28 Feb 2025</p>
										</div>
									</div>
