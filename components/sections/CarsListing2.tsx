						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.1s">
							<div className="card-journey-small background-card hover-up">
								...
								<div className="card-info p-4 pt-30">
									...
									<div className="card-title"><Link className="text-lg-bold neutral-1000 text-nowrap" href="">Volkswagen Golf GTD</Link></div>
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.2s">
							<div className="card-journey-small background-card hover-up">
								...
								<div className="card-info p-4 pt-30">
									...
									<div className="card-title"><Link className="text-lg-bold neutral-1000" href="">Volvo S60 D4 R-Design</Link></div>
									<div className="card-program">
										<div className="card-location">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.3s">
							<div className="card-journey-small background-card hover-up">
								...
								<div className="card-info p-4 pt-30">
									...
									<div className="card-title"><Link className="text-lg-bold neutral-1000" href="">Jaguar XE 2.0d R-Sport</Link></div>
									<div className="card-program">
										<div className="card-location">
											<p className="text-location text-sm-medium neutral-500">Manchester, England</p>
										</div>
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.4s">
							<div className="card-journey-small background-card hover-up">
								...
								<div className="card-info p-4 pt-30">
									...
									<div className="card-title"><Link className="text-lg-bold neutral-1000" href="">Lexus IS 300h F Sport</Link></div>
									<div className="card-program">
										<div className="card-location">
											<p className="text-location text-sm-medium neutral-500">Manchester, England</p>
										</div>
