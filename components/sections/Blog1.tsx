									...
									<SwiperSlide className="swiper-slide pt-2">
										<div className="card-news background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="text-xl-bold neutral-1000" href="">2025 Cadillac Escalade costs more money
												</Link></div>
									...
									<SwiperSlide className="swiper-slide pt-2">
										<div className="card-news background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-meta"><span className="post-date neutral-1000">18 Sep
													2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
												<div className="card-title"><Link className="text-xl-bold neutral-1000" href="">2025 BMW 5 Series Review: A balanced luxury
													sedan</Link></div>
												<div className="card-program">
													<div className="endtime">
														<div className="card-author">
									...
									<SwiperSlide className="swiper-slide pt-2">
										<div className="card-news background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-meta"><span className="post-date neutral-1000">18 Sep
													2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
												<div className="card-title"><Link className="text-xl-bold neutral-1000" href="">2025 Ruf Rodeo is ready to wrangle some
