		...
		<>
			...
			<section className="box-section block-banner-home1 position-relative">
				<div className="container position-relative z-1">
					...
					<h1 className="color-white mb-35 wow fadeInUp">Looking for a vehicle? <br className="d-none d-lg-block" />You’re in the perfect spot with AI-powered recommendations!</h1>
