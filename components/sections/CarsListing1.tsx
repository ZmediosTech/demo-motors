			...
			<section className="section-box box-flights background-body">
				<div className="container">
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Audi A3 1.6 TDI S line</Link></div>
										...
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Volvo S60 D4 R-Design</Link></div>
												<div className="card-program">
													<div className="card-location">
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Mercedes-Benz C220d</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
										...
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Jaguar XE 2.0d R-Sport</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000 text-nowrap" href="/">Volkswagen Golf GTD 2.0 TDI</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
										...
										<div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Lexus IS 300h F Sport</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
					...
					<div className="d-flex justify-content-center">
						<Link className="btn btn-brand-2 text-nowrap wow fadeInUp" href="">
