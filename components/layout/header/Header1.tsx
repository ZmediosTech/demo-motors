					...
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">+91 8561073404</span>
							</Link>
							<Link className="email-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">info@myfinder.com</span>
							</Link>
						</div>
						<div className="text-header">
							...
							<Link className="btn btn-brand-2 btn-small text-dark px-3 py-2 text-xs-medium " href="">
								Access Now
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
												...
												<div className="mega-menu-inner mega-menu-inner-small">
													<div className="row">
														<div className="col-lg-6">
															...
															<ul className="sub-menu">
																<li><Link href="">Cars List v1</Link></li>
										...
										<li><Link className="color-white" href="">Contact</Link></li>
									</ul>
								</nav>
							</div>
							<div className="header-right">
								<div className="d-none d-xxl-inline-block align-middle mr-15">
									<Link className="btn btn-signin" href="">
									...
									<Link className="btn btn-signin bg-white text-dark" href="">Add Listing</Link>
								</div>
